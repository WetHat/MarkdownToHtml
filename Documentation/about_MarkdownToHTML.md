...
[`New-HTML-Template`](New-HTML-Template.md) or creating a HTML site project by
[`New-StaticHTMLSiteProject`](New-StaticHTMLSiteProject.md).

Use [`New-HTML-Template`](New-HTML-Template.md) if only simple customization involving style sheet
...
Template directories generated by either [`New-HTML-Template`](New-HTML-Template.md) or
...
:   The HTML template file. This file defines the basic structure of the
    ...
    `md-template.html` needs to load all JavaScript and stylesheet resources
...
be mapped to a HTML fragment to replace the placeholder with during the
build process. This can be done by adding an entry to the content map
defined in `Build.ps1`. For example:
